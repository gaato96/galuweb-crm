    ...
    return (
        <div className="space-y-5 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                    <h2 className="text-xl sm:text-2xl font-bold text-foreground">Pipeline de Clientes</h2>
                    <p className="text-xs sm:text-sm text-muted-foreground">{clientes.length} contactos en total</p>
                </div>
                <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                    ...
                    <div className="relative flex-1 sm:flex-initial min-w-[140px]">
                        ...
                        <input
                            ...
                            placeholder="Buscar..."
                            className="w-full sm:w-[180px] lg:w-[200px] h-9 pl-9 pr-3 rounded-xl bg-secondary border border-border text-xs text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50"
                        />
                    </div>
                    <button
                        onClick={() => setShowNew(true)}
                        className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-primary text-primary-foreground text-xs sm:text-sm font-bold hover:opacity-90 transition-opacity shrink-0"
                    >
